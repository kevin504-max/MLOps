...
def main():
    try:
        ...
        plt.legend()
        plt.grid(True)
        plt.savefig(os.path.join(graphs_output_dir, 'gmm_temp_vs_mq7_simulated.png'))
        plt.close()
        ...
        plt.legend()
        plt.grid(True)
        plt.savefig(os.path.join(graphs_output_dir, 'gmm_humidity_vs_mq4_simulated.png'))
        plt.close()
        ...
        pairplot.savefig(os.path.join(graphs_output_dir, 'gmm_pairplot_simulated.png'))
        plt.close()
        ...
        plt.savefig(os.path.join(graphs_output_dir, 'gmm_3d_clusters_simulated.png'))
        plt.close()
        ...
        plt.grid(True)
        plt.tight_layout()
        plt.savefig(os.path.join(graphs_output_dir, 'gmm_cluster_means_simulated.png'))
        plt.close()
        ...
        if 'Timestamp' in df.columns:
            ...
            plt.grid(True)
            plt.tight_layout()
            plt.savefig(os.path.join(graphs_output_dir, 'gmm_cluster_over_time_simulated.png'))
            plt.close()
        else:
